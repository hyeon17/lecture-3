	...
	return (
		<div className='MainPage -mt-16'>
			...
			<div className='mx-auto'>
				<ThreeColumns
					columns={[
						<Card image={main1} webpImage={main1_webp} sources={[{ srcset: main1_webp, type: 'image/webp' }]}>
							롱보드는 아주 재밌습니다.
						</Card>,
				...
				<TwoColumns
					bgColor={'#f4f4f4'}
					columns={[
						<LazyImage src={main_items} sources={[{ srcset: main_items, type: 'image/jpeg' }]} />,
						<Meta
							title={'Items'}
							content={
				...
				<TwoColumns
					...
					columns={[
						<Meta
							...
							btnLink={'/part'}
						/>,
						<LazyImage src={main_parts} sources={[{ srcset: main_parts, type: 'image/jpeg' }]} />,
					]}
					mobileReverse={true}
				/>
				<TwoColumns
					bgColor={'#f4f4f4'}
					columns={[
						<LazyImage src={main_styles} sources={[{ srcset: main_styles, type: 'image/jpeg' }]} />,
						<Meta
							title={'Riding Styles'}
							content={
